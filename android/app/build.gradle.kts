...
android {
    ...
    defaultConfig {
        applicationId = "com.hendash.hendash"
        minSdk = 30
        targetSdk = 35
...
dependencies {
    // Required by flutter_local_notifications 18.x — pulls in java.time.* backports
    // so scheduled notifications work on API 30–33 devices.
